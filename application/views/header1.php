<header class="navbar navbar-inverse">
    ...
    <ul id="widgets" class="navbar-nav-custom pull-right">
        ...
        <li class="dropdown dropdown-left-responsive">
            <form action="page_search_results.html" method="post" class="form-wrapper cf">
        ...
        <li class="dropdown dropdown-left-responsive">
            <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                <img  style="width:25px; height:25px;" src="../backend/img/template/calculator.png">
            </a>
            <ul class="dropdown-menu pull-right widget">
        ...
        <li class="dropdown pull-right dropdown-user">
            <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"><!--<img src="{user_avatar}" alt="avatar" class="avatar">-->Avatar <b class="caret"></b></a>

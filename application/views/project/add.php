            ...
            <div class="col-md-12">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input name="name"  required='required' type="text" id="name" placeholder="Name" value="<?php echo $v?>"  class="form-control">
                ...
                <button id="nextBtn" class="btn btn-primary nextBtn btn-lg pull-right" >Next</button>
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="col-lg-12 text-center">
                    <input type="submit" name="submit" class="btn btn-info margin-r-5" value="Save">
